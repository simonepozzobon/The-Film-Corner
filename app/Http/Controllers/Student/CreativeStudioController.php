    ...
    switch ($app_slug) {
      ...
      **/
      ...
      case 'character-builder':
        ...
        return view('student.creative-studio.character-builder.index', compact('app', 'app_category', 'images', 'elements'));
        break;
    ...
    switch ($app_slug) {
      ...
      **/
      ...
      case 'active-parallel-action':
        ...
        return view('student.creative-studio.active-parallel-action.open', compact('app', 'app_category', 'app_session', 'is_student', 'elements', 'session', 'timelines', 'token'));
        break;
      ...
      **/
      ...
      case 'character-builder':
        ...
        return view('student.creative-studio.character-builder.open', compact('app', 'app_category', 'app_session', 'is_student', 'session', 'images', 'elements'));
        break;
