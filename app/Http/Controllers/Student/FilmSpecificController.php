    ...
    switch ($app_slug) {
      ...
      **/
      ...
      case 'frame-composer':
        ...
        return view('student.film-specific.frame-composer.index', compact('app', 'app_category', 'images', 'elements'));
        break;
      ...
      case 'types-of-images':
        ...
        return view('student.film-specific.types-of-images.index', compact('app', 'app_category', 'media_couples', 'random'));
        break;
      ...
      **/
      ...
      return view('student.film-specific.whats-going-on.index', compact('app', 'app_category', 'random_audio'));
      break;
  ...
  public function openSession($category, $app_slug, $token)
  {
    ...
    switch ($app_slug) {
      ...
      case 'frame-composer':
        ...
        return view('student.film-specific.frame-composer.open', compact('app', 'app_category', 'session', 'app_session', 'is_student', 'images', 'elements'));
        break;
      ...
      case 'types-of-images':
        ...
        return view('student.film-specific.types-of-images.open', compact('app', 'app_category', 'session', 'app_session', 'is_student', 'media_couples'));
        break;
