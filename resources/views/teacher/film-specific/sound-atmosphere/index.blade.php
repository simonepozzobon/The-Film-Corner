    ...
    <div class="row mt">
      <div class="col">
        <div class="box green">
          ...
          <div class="box-body">
            <textarea id="notes" name="notes" rows="8" class="form-control input-green" placeholder="{{ GeneralText::field('sound_atmosphere_desc') }}"></textarea>
          </div>
        </div>
      </div>
    </div>
...
@section('scripts')
  ...
  <script>
    ...
    {
        var video_player = document.getElementById('media-element').offsetHeight - 43;
