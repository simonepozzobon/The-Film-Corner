  ...
  <section id="breadcrumbs pr-5 pl-5 pb-5">
    <div class="row">
      <div class="col pr-5 pl-5">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ route('student') }}">Studios</a></li>
                ...
                <div class="row">
                  <div class="col {{ $app->colors }} p-5">
                    ...
                    <div class="d-flex justify-content-around">
                      <div class="">
                        @if ($app->available == 1)
                          <a href="{{ route('student.creative-studio.app', [$app_category->slug, $app->slug]) }}" class="btn btn-secondary btn-{{ $app->colors }}" >
                        ...
                        @endif
                        <a href="#" onclick="openSessions({{ Auth::guard('student')->Id() }}, {{ $app->id }})" class="btn btn-secondary btn-{{ $app->colors }}" >
