    ...
    <div class="row mt">
      <div class="col">
        <div class="box green">
          ...
          <div class="box-body">
            <textarea id="notes" name="notes" rows="8" class="form-control" placeholder="Listen to the audioclip and try to guess what’s happening">{{ $session->notes }}</textarea>
          </div>
        </div>
      </div>
    </div>
