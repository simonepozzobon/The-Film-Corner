      ...
      success: function (response) {
        console.log(response);
          ...
          for (var i = 0; i < dataLenght; i++) {
            ...
            data +=       '<a href="/guest/film-specific/'+response.category+'/'+response.app['slug']+'/'+response.sessions[i]['token']+'" class="btn btn-'+color+'"><i class="fa fa-folder-open-o" aria-hidden="true"></i> Open</a>';
