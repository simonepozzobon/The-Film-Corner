const filmography = [
    {
        text:
            "“Ten Minutes in the Morning” Soviet Morning Exercise Routine,	Aleksandre Jaliashvili, USSR	1931	Documentary"
    },
    {
        text:
            "Al Congresso Nazista di Norimberga. Il Fuhrer presenzia l'adunata di 45.000 organizzati della gioventù Hitleriana allo Stadio Municipale.	Arnaldo Ricotti	Italy	1936	Documentary"
    },
    {
        text:
            "Al di là di questo reticolato. La costruzione delle barriere di divisione tra la Repubblica Federale tedesca e la Repubblica Democratica tedesca.	Na	Italy	1962	Documentary"
    },
    { text: "Aleksandr Nevskij	Sergej Michajlovič Ėjzenštejn" },
    { text: "USSR	1938	Fiction" },
    { text: "Avgust. Vosʹmogo	Dzhanik Fayziev	Russia	2012	Fiction" },
    { text: "Berlin – The Wall of Shame	Na	UK	1961	Documentary" },
    { text: "Bombardamento di Roma	Na	Italy	1943	Documentary" },
    {
        text: "Čapaev	Sergej Dmitrievič Vasil’ev, Georgi Vasilyev	USSR	1934	Fiction"
    },
    {
        text:
            "Caratteristica festa contadina della mietitura	Arturo Gemmiti	Italy	1935	Documentary"
    },
    { text: "Chelovek s kino-apparatom	Dziga Vertov" },
    { text: "USSR	1929	Documentary" },
    { text: "Chocolat	Roschd Zem	France	2016	Fiction" },
    { text: "Delicatessen	Jean-Pierre Jeunet, Marc Caro	France	1991	Fiction" },
    { text: "Dheepan	Jaqes Audiard	France	2015	Fiction" },
    {
        text:
            "Die Fälschung	Volker Schlöndorff	Germany, Belgium, France	1981	Fiction"
    },
    { text: "Die Mauer	Jürgen Böttcher" },
    { text: "Germany	1990	Documentary" },
    { text: "Die schwarzen Brüder	Xavier Koller" },
    { text: "Germany, Switzerland	2013	Fiction" },
    { text: "Dogman	Matteo Garrone	Italy	2018	Fiction" },
    {
        text:
            "Effetti dei bombardamenti tedeschi sulla Capitale inglese	Arturo Gemmiti	Italy	1941	Documentary"
    },
    { text: "En Guerre	Stéphane Brizé	France	2018	Fiction" },
    { text: "Entuziazm	Dziga Vertov" },
    { text: "USSR	1931	Documentary" },
    { text: "Fuocoammare	Gianfranco Rosi	Italy	2016	Documentary" },
    { text: "German Youth Display	Na	Germany	1940	Documentary" },
    { text: "Gernika	Koldo Serra	Spain	2016	Fiction" },
    { text: "Giarabub	Goffredo Alessandrini	Italy	1942	Fiction" },
    {
        text:
            "Gli effetti del bombardamento inglese su Parigi	Na	Italy	1942	Documentary"
    },
    { text: "Guardate questa città	Na	Italy	1961	Documentary" },
    { text: "Hitlerjunge Quex	Hans Steinhoff" },
    { text: "Germany	1933	Fiction" },
    { text: "I, Daniel Blake	Ken Loach	UK, France, Belgium	2016	Fiction" },
    { text: "Il Dottor Churkill	Luigi Liberio Pensuti	Italy	1942	Animation" },
    {
        text:
            "Il Duce annuncia in Piazza Venezia la storica decisione dell'Italia di uscire dalla Società delle Nazioni	Arnaldo Ricotti	Italy	1937	Documentary"
    },
    {
        text:
            "Inaugurazione di una Mostra di economia domestica	Arturo Gemmiti	Italy	1937	Documentary"
    },
    { text: "Intouchables	Olivier Nakache, Éric Toledano" },
    { text: "France	2011	Fiction" },
    { text: "Istanbul Kirmizisi	Ferzan Ozpetek	Italy, Turkey	2017	Fiction" },
    { text: "Jupiter holdja	Kornél Mundruczó" },
    { text: "Hungary	2017	Fiction" },
    { text: "Kino-tsirk	Leonid Amalrik, Olga Khodatayeva" },
    { text: "USSR	1942	Animation" },
    {
        text:
            "La Cité des Enfants Perdus	Jean-Pierre Jeunet, Marc Caro	France	1995	Fiction"
    },
    { text: "La festa della mietitura	Arnaldo Ricotti	Italy	1939	Documentary" },
    { text: "La grande bellezza	Paolo Sorrentino	Italy, France	2013	Fiction" },
    { text: "La I° festa del mietitore	Arnaldo Ricotti	Italy	1937	Documentary" },
    { text: "La IX Olimpiade ad Amsterdam	Na	Italy	1928	Documentary" },
    { text: "La Loi du Marché	Stéphane Brizé	France	2015	Fiction" },
    { text: "La Prière	Cédric Kahn	France	2018	Fiction" },
    { text: "La scuola delle mogli	Na	Italy	1951	Documentary/Fiction" },
    {
        text:
            "La Vie d'Adèle: Chapitres 1 & 2	Abdellatif Keichiche	France	2013	Fiction"
    },
    {
        text:
            "L'attacco su Roma e la visita di Maria José a San Lorenzo	Na	Italy	1948	Documentary"
    },
    { text: "Le confessioni	Roberto Andò	Italy	2016	Fiction" },
    {
        text:
            "Le Fabuleux Destin d'Amélie Poulain	Jean-Pierre Jeunet	France, Germany	2001	Fiction"
    },
    { text: "Le Huitième Jour	Jacon Van Dormael	Belgium, France	1996	Fiction" },
    { text: "Le Tout Nouveau Testament	Jacon Van Dormael	Belgium	2015	Fiction" },
    {
        text:
            "London Bombing Footage (CBS Documentary Extract)	Na	USA, UK	1940	Documentary"
    },
    { text: "Loro 1	Paolo Sorrentino	Italy	2018	Fiction" },
    { text: "Ma Loute	Bruno Dumont	France	2016	Fiction" },
    { text: "Malèna	Giuseppe Tornatore	Italy	2000	Fiction" },
    { text: "May 1st Celebrations	Zorz Skrigin	USSR	1948	Documentary" },
    { text: "May 1st in Berlin	Na	UK	1938	Documentary" },
    { text: "May 1st in Moscow	Na	UK	1938	Documentary" },
    {
        text:
            "Mostra di economia domestica e delle scuole rurali	Arnaldo Ricotti	Italy	1937	Documentary"
    },
    {
        text:
            "Mussolini si cimenta nella trebbiatura del grano	Arnaldo Ricotti	Italy	1935	Documentary"
    },
    {
        text:
            "Ne toptat fashistskomu sapogu nashey rodiny	Ivan Ivanov-Vano, Aleksandr Ivanov	USSR	1941	Animation"
    },
    {
        text:
            "Nel Mezzogiorno qualcosa è cambiato	Carlo Lizzani	Italy	1950	Documentary"
    },
    { text: "Nimbus libéré	Raymond Jeannin" },
    { text: "France	1944	Animation" },
    { text: "Olympia: Fest der Völker	Leni Riefenstahl	Germany	1938	Documentary" },
    { text: "Orecchie	Alessandro Aronadio	Italy	2016	Fiction" },
    {
        text:
            'Preparativi per la ripresa della battaglia di Zama sulla piana di Sabaudia per il film:"Scipione l\'Africano"	Arnaldo Ricotti	Italy	1936	Documentary'
    },
    {
        text:
            "Riprese di operatori sovietici nell’Italia degli anni ‘20	Na	USSR, Italy	1926	Documentary"
    },
    { text: "S.A.-Mann Brand	Franz Seitz Sr.	Germany	1933	Fiction" },
    {
        text:
            "Saggio della G.I.L. in presenza di Mussolini	Arnaldo Ricotti, Franchina Basilio	Italy	1940	Documentary"
    },
    { text: "Scipione l'Africano	Carmine Gallone	Italy	1937	Fiction" },
    { text: "Sole a catinelle	Gennaro Nunziante	Italy	2013	Fiction" },
    { text: "Straža na Drini	Branko Marjanovic	Croatia	1942	Documentary" },
    { text: "The Artist	Michel Hazanavicius	France	2011	Fiction" },
    { text: "The Belly of an Architect	Peter Greenaway	UK	1987	Fiction" },
    { text: "The Boy in the Striped Pajamas	Mark Herman" },
    { text: "USA, UK, Hungary	2008	Fiction" },
    { text: "The Party	Sally Potter	UK	2017	Fiction" },
    { text: "Theresienstadt propaganda films	Na	Germany, UK	1944	Documentary" },
    { text: "Triumph des Willens	Leni Riefenstahl	Germany	1935	Documentary" },
    { text: "Tutti a casa	Luigi Comencini	Italy	1960	Fiction" },
    { text: "Winston Churchill (BBC Footage)	Na	UK	1940s	Documentary" },
    {
        text:
            "Youth - La giovinezza	Paolo Sorrentino	Italy, Switzerland, France, United Kingdom	2015	Fiction"
    },
    {
        text:
