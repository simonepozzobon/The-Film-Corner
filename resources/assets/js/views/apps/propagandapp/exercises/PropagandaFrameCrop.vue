...
import { UiAppPropagandaPlayer, UiAppCroppedFrames } from "../../../../uiapp";
...
export default {
    ...
    methods: {
        ...
        getData: function() {
            ...
            // perform api call
            let url =
                "/api/v2/propaganda/clip/" + id + "/exercise/" + exerciseId;
        ...
        deleteFrame: function(id) {
            this.frames = Object.assign(
                [],
                this.frames.filter(frame => frame.id != id)
            );
        }
    },
    created: function() {
