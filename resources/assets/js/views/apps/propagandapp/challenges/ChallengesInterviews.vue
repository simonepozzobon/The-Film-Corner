            ...
            <div class="propaganda-back__container">
                <div class="propaganda-back__content">
                    <ui-container class="prop-ex-container">
                        ...
                        <ui-container :contain="true" class="prop-affiches">
                            <ui-row>
                                <ui-block
                                    :size="6"
                                    color="dark-gray"
                                ...
                                >
                                    <div class="p-5">
                                        ...
                                        <p
                                            ...
                                            v-html="
                                                $root.getCmd(
                                                    'upload_propaganda_interview_types'
                                                )
                                            "
                                        ></p>
                                        ...
                                        <div class="form-group form-disclaimer">
                                            ...
                                            <div
                                                class="form-disclaimer__warning"
                                            >
                                                {{
                                                    $root.getCmd(
                                                        "upload_disclaimer"
