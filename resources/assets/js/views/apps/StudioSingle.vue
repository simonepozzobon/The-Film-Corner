            ...
            <ui-container :full-width="true" v-if="this.studio">
                <ui-row align="center">
                    <ui-block :size="4">
                        <ui-title
                            :title="
                                this.studio | translate('name', $root.locale)
                            "
                            :uppercase="false"
                            tag="h1"
                            font-size="h1"
                ...
                <ui-row justify="center">
                    ...
                    >
                        ...
                        />
                        <studio-block-app-loop
                            class="block-menu"
                            item-class="block-menu__menu-item"
                            :apps="cat.apps"
                        />
                        <!-- <ul class="block-menu">
                        <li
...
import StudioBlockAppLoop from "../../components/StudioBlockAppLoop";
import {
    UiBlock,
    UiButton,
    UiContainer,
