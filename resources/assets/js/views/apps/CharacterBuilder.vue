...
export default {
    ...
    methods: {
        ...
        addToCanvas: function (index, libraryID) {
            ...
            // let idx = this.assets.library.findIndex(library => library.id ==
            //     libraryID)
            // if (idx > -1) {
            ...
            //         let height = (this.canvasHeight / (this.groups.length -
            //             1))
            //         scaleFactor = scaleFactor / (this.groups.length -
            //             1)
            //         this.groups[idx].set({
            //             centeredScaling: true,
            //             scaleX: scaleFactor,
