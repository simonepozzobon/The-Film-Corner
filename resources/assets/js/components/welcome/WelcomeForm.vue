...
<div id="welcome-form" class="box blue">
    ...
    <div class="box-body">
        ...
        <div class="row pt">
            <div class="col-md-4">
                <div class="form-group">
                    <input type="text" class="form-control" :placeholder="first_word+'...'" v-model="word_1">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <input type="text" class="form-control" :placeholder="second_word+'...'" v-model="word_2">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <input type="text" class="form-control" :placeholder="third_word+'...'" v-model="word_3">
                </div>
            </div>
        </div>
        ...
        <div class="row pt">
            <div class="col">
                <div class="form-group">
                    <textarea rows="4" class="form-control" :placeholder="your_answer+'...'" v-model="answer" />
                </div>
            </div>
        </div>
