<template lang="html">
    <div
        ...
        :class="[colorClass, blobColorClass]"
        ref="container"
    >
        <div class="timeline-track__head" @click="editTitle">
            <span ref="title" class="timeline-track__title">
                {{ title }}
            </span>
            <div class="timeline-track__input tools" ref="tools">
                <input
                    class="form-control"
                    v-model="title"
    ...
    methods: {
        ...
        saveTitle: function(isDelete = false) {
            return new Promise(resolve => {
                ...
                var t1 = new TimelineMax();
                t1.to(this.$refs.tools, 0.2, {
                    opacity: 0,
                    display: "none",
                    ease: Power4.easeInOut
                }).to(this.$refs.title, 0.2, {
                    opacity: 1,
                    display: "block",
                    ease: Power4.easeInOut,
                    onComplete: () => {
