<template>
    <div class="ua-single-res">
        <div class="ua-single-res__container">
            <div class="ua-single-res__thumb" @click="openResult">
            ...
            <div class="ua-single-res__details">
                ...
                <div class="ua-single-res__director">
                    <span
                        ...
                        :key="director.id"
                    >
                        <span v-if="i < content.directors.length - 1">
                            {{ director | translate("name", $root.locale) }},
                            &nbsp;
                        </span>
                        <span v-else>
                            {{ director | translate("name", $root.locale) }}
                ...
                <div class="ua-single-res__tags">
                    ...
                    >
                        <span v-if="i != content.topics.length - 1">
                            {{ topic | translate("title", $root.locale) }},
                            &nbsp;
                        </span>
                        <span v-else>
                            {{ topic | translate("title", $root.locale) }}
                ...
                <div class="ua-single-res__tags" v-if="content.tags">
                    <div
                        class="ua-single-res__tag"
                    ...
                    >
                        <span v-if="i != content.tags.length - 1">
                            {{ tag | translate("title", $root.locale) }},&nbsp;
                        </span>
                        <span v-else>
                            {{ tag | translate("title", $root.locale) }}
                        </span>
...
<script>
import { UiImage, UiTitle } from "../../../ui";
