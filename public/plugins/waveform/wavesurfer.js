/*!
 * wavesurfer.js 2.0.0-beta01 (Sun Aug 20 2017 13:02:11 GMT+0200 (CEST))
...
var MultiCanvas = function (_Drawer) {
    ...
    _createClass(MultiCanvas, [{
        ...
        value: function drawBars(peaks, channelIndex, start, end) {
            ...
            util.frame(function (peaks, channelIndex, start, end) {
                // Split channels
                if (peaks[0] instanceof Array) {
                    var channels = peaks;
                    if (_this4.params.splitChannels) {
                        _this4.setHeight(channels.length * _this4.params.height * _this4.params.pixelRatio);
                ...
                var height = _this4.params.height * _this4.params.pixelRatio;
        ...
        value: function drawWave(peaks, channelIndex, start, end) {
            ...
            util.frame(function (peaks, channelIndex, start, end) {
                ...
                if (peaks[0] instanceof Array) {
                    var channels = peaks;
                    if (_this5.params.splitChannels) {
                        _this5.setHeight(channels.length * _this5.params.height * _this5.params.pixelRatio);
                        channels.forEach(function (channelPeaks, i) {
                ...
                // A half-pixel offset makes lines crisp
                var height = _this5.params.height * _this5.params.pixelRatio;
                var offsetY = height * channelIndex || 0;
                var halfH = height / 2;

                var absmax = 1;
                if (_this5.params.normalize) {
                    var max = util.max(peaks);
                    var min = util.min(peaks);
                    absmax = -min > max ? -min : max;
                }
