  ...
  methods: {
    ...
    saveEdits: function saveEdits() {
      ...
      if (this.type == 'filmography') {
        ...
        _axios2.default.post('/admin/footer/update_filmography', data).then(function (response) {
          _this.closeEdit();
          _this.$parent.$emit('filmography-updated', response.data);
        });
      } else {
        // edit credit
        ...
        _axios2.default.post('/admin/footer/update_credit', data).then(function (response) {
          _this.closeEdit();
          _this.$parent.$emit('credit-updated', response.data);
        });
      }
    },
    openEdit: function openEdit() {
      _gsap.TweenMax.to(this.$refs.edit_row, .4, {
        opacity: 1,
        display: 'table-row',
...
var _ElementSingle = __webpack_require__(640);
...
exports.default = {
  ...
  methods: {
    ...
    getCredits: function getCredits() {
      ...
      _axios2.default.get('/admin/footer/get_credits').then(function (response) {
        _this.credits = response.data;
      });
    },
    getFilmography: function getFilmography() {
      var _this2 = this;

      _axios2.default.get('/admin/footer/get_filmography').then(function (response) {
        _this2.filmographies = response.data;
      });
    },
    openPanel: function openPanel() {
      if (this.panel == 'filmography') {
        _gsap.TweenMax.to(this.$refs.panelFilmography, .4, {
          opacity: 1,
          display: 'block',
          easing: _gsap.Power4.easeInOut
        });
      } else if (this.panel == 'credits') {
        _gsap.TweenMax.to(this.$refs.panelCredits, .4, {
          opacity: 1,
          display: 'block',
          easing: _gsap.Power4.easeInOut
        });
    ...
    addCredit: function addCredit() {
      // Show form Credit
      _gsap.TweenMax.to(this.$refs.add_panel_credit, .4, {
        opacity: 1,
        display: 'inherit',
        easing: _gsap.Power4.easeInOut
      });
    ...
    addFilm: function addFilm() {
      // Show form Film
      _gsap.TweenMax.to(this.$refs.add_panel_film, .4, {
        opacity: 1,
        display: 'inherit',
        easing: _gsap.Power4.easeInOut
      });
    },
    undoCredit: function undoCredit() {
      // Hide form Credit
      _gsap.TweenMax.to(this.$refs.add_panel_credit, .4, {
        opacity: 0,
        display: 'none',
    ...
    saveCredit: function saveCredit() {
      var _this3 = this;
      ...
      _axios2.default.post('/admin/footer/save_credit', data).then(function () {
        _this3.undoCredit();
        _this3.getCredits();
      });
    },
    saveFilm: function saveFilm() {
      var _this4 = this;
      ...
      _axios2.default.post('/admin/footer/save_filmography', data).then(function () {
        _this4.undoFilm();
        _this4.getFilmography();
      });
    }
  },
  mounted: function mounted() {
    ...
    this.$on('filmography-updated', function () {
      _this5.getFilmography();
    });
    this.$on('credit-updated', function () {
      _this5.getCredits();
    });
  },

  components: {
    ElementSingle: _ElementSingle2.default
  }
}; //
//
//
...
var _MainPanel = __webpack_require__(641);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_ElementSingle_vue__ = __webpack_require__(410);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_ElementSingle_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_ElementSingle_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_ElementSingle_vue__) if(["default","default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_ElementSingle_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ccff4fd_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ElementSingle_vue__ = __webpack_require__(724);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-1ccff4fd"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_ElementSingle_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_1ccff4fd_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ElementSingle_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources/assets/admin/js/footer/components/ElementSingle.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1ccff4fd", Component.options)
  } else {
    hotAPI.reload("data-v-1ccff4fd", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_MainPanel_vue__ = __webpack_require__(411);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_MainPanel_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_MainPanel_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_MainPanel_vue__) if(["default","default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_MainPanel_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_49416f64_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_MainPanel_vue__ = __webpack_require__(755);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-49416f64"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_node_modules_vue_loader_lib_selector_type_script_index_0_MainPanel_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_49416f64_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_MainPanel_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources/assets/admin/js/footer/components/MainPanel.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-49416f64", Component.options)
  } else {
    hotAPI.reload("data-v-49416f64", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(8)("5ba6e976", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1ccff4fd\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ElementSingle.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1ccff4fd\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ElementSingle.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("141e95a6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-49416f64\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MainPanel.vue", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-49416f64\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./MainPanel.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
